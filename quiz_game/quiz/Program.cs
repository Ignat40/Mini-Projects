...
namespace Quiz_Game
{
    ...
    public class Program
    {
        ...
        static QuizQuestions[] historyQuestions = new QuizQuestions[]
        {
            new QuizQuestions
            {
        ...
        static QuizQuestions[] biologyQuestions = new QuizQuestions[]
        {
            new QuizQuestions
            {
        ...
        static QuizQuestions[] mathQuestions = new QuizQuestions[]
        {
            new QuizQuestions
            {
        ...
        static QuizQuestions[] sportQuestions = new QuizQuestions[]
                {
            new QuizQuestions
            {
        ...
        public static void LoadQuestions()
        {
            ...
            QuizQuestions[] selectedQuestions = null;

            // Select questions based on the chosen category
            switch ((QuizCategories)categoryIndex)
            {
                case QuizCategories.GeneralKnowladge:
                    selectedQuestions = gkQuestions;
                    break;
                case QuizCategories.History:
                    selectedQuestions = historyQuestions;
                    break;
                case QuizCategories.Biology:
                    selectedQuestions = biologyQuestions;
                    break;
                case QuizCategories.Mathematic:
                    selectedQuestions = mathQuestions;
                    break;
                case QuizCategories.Sport:
            ...
            while (counter < 5) 
            {
                ...
                Console.WriteLine($"{selectedQuestions[counter].Question}");

                Console.WriteLine("--------------------");
                for (int i = 0; i < selectedQuestions[counter].QuestionOptions.Length; i++)
                {
                    Console.WriteLine($"{i}. {selectedQuestions[counter].QuestionOptions[i]}");
                }

                Console.WriteLine("Answer: ");
                if (int.TryParse(Console.ReadLine(), out int answer))
                {
                    if (answer == selectedQuestions[counter].CorrectAnswerIndex)
                    {
                        playerScore += selectedQuestions[counter].Points;
                        Console.WriteLine("Correct!");
                    }
                    else
                    {
                        Console.WriteLine("\nWrong answer. The correct answer is: " + selectedQuestions[counter].CorrectAnswerIndex);
                    }
            ...
            Console.WriteLine($"Your final score: {playerScore}");
